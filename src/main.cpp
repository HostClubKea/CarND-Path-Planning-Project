...
int main() {
    ...
    Map map;
    map.init(map_waypoints_s, map_waypoints_x, map_waypoints_y, map_waypoints_dx, map_waypoints_dy);
                        ...
                        if (event == "telemetry") {
                            ...
                            for (int i = 0; i < sensor_fusion.size(); i++) {
                                ...
                                if (d < (2 + 4 * lane + 2) && d > (2 + 4 * lane - 2)) {
                                    ...
                                    // Check s value greater then mine and s gap
                                    if ((check_car_s > car_s) && ((check_car_s - car_s) < 30)) {
                                        // Do some logic here, lower reference velocity so we don't crash into car infront of us
                                        // Also could try to change lanes
                                        //ref_vel = 29.5; // mph
                                        too_close = true;
                                    }
